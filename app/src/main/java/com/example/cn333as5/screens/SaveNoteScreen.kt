...
fun SaveNoteScreen(viewModel: MainViewModel) {
    ...
    val bottomDrawerState_c = rememberBottomDrawerState(BottomDrawerValue.Closed)
    ...
    BackHandler {
        if (bottomDrawerState_c.isOpen) {
            coroutineScope.launch { bottomDrawerState_c.close() }
        } else {
    ...
    Scaffold(
        topBar = {
            ...
            SaveNoteTopAppBar(
                ...
                onOpenColorPickerClick = {
                    check.value = true
                    coroutineScope.launch { bottomDrawerState_c.open() }
                },
        ...
        BottomDrawer(
            drawerState = bottomDrawerState_c,
            drawerContent = {
                if (check.value) {
                    ColorPicker(
                        colors = colors,
